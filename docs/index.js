...
async function createUserSession({ request, userId, remember, redirectTo }) {
  ...
  return (
    ...
    (0, import_node.redirect)(redirectTo, {
      headers: {
...
var action = async ({ request }) => logout(request),
  loader3 = async () => (0, import_node3.redirect)("/");
...
function useMatchesData(id) {
  let matchingRoutes = (0, import_react3.useMatches)(),
    route = (0, import_react4.useMemo)(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            ...
            {
              className:
                "relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pb-20 lg:pt-32",
            },
            /* @__PURE__ */ React.createElement(
              "h1",
              {
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement("img", {
                ...
                alt: "Remix",
                className:
                  "mx-auto mt-16 w-full max-w-[12rem] md:max-w-[16rem]",
              })
            )
          )
        )
          ...
          [
            ...
            /* @__PURE__ */ React.createElement(
              "a",
              {
                ...
                href: img.href,
                className:
                  "flex h-16 w-32 justify-center p-1 grayscale transition hover:grayscale-0 focus:grayscale-0",
              },
              /* @__PURE__ */ React.createElement("img", {
                alt: img.alt,
                src: img.src,
...
var loader4 = async ({ request }) =>
  ...
  action2 = async ({ request }) => {
    let formData = await request.formData(),
      ...
      redirectTo = safeRedirect(formData.get("redirectTo"), "/notes"),
...
function LoginPage() {
  ...
  let [searchParams] = (0, import_react6.useSearchParams)(),
    ...
    actionData = (0, import_react6.useActionData)(),
    emailRef = React2.useRef(null),
    passwordRef = React2.useRef(null);
  return (
    React2.useEffect(() => {
      var _a2, _b2, _c2, _d2;
      (
...
function NotesPage() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", null, user.email),
      /* @__PURE__ */ React.createElement(
        import_react7.Form,
        {
          action: "/logout",
        ...
        /* @__PURE__ */ React.createElement(
          "button",
          {
            type: "submit",
            className:
              "rounded bg-slate-600 py-2 px-4 text-blue-100 hover:bg-blue-500 active:bg-blue-600",
          },
          "Logout"
        )
      )
...
function NewNotePage() {
  ...
  let actionData = (0, import_react10.useActionData)(),
    titleRef = React3.useRef(null),
    bodyRef = React3.useRef(null);
  return (
    React3.useEffect(() => {
      var _a2, _b2, _c2, _d2;
      (
    ...
    /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(
        ...
        /* @__PURE__ */ React3.createElement(
          ...
          /* @__PURE__ */ React3.createElement("span", null, "Body: "),
...
function Join() {
  ...
  let [searchParams] = (0, import_react11.useSearchParams)(),
    ...
    actionData = (0, import_react11.useActionData)(),
    emailRef = React4.useRef(null),
    passwordRef = React4.useRef(null);
  return (
    React4.useEffect(() => {
      var _a2, _b2, _c2, _d2;
      (
...
var assets_manifest_default = {
  version: "1540e7cf",
  entry: {
    module: "/build/entry.client-KJ7BNHRB.js",
    imports: [
      "/build/_shared/chunk-QO45Z4EI.js",
      "/build/_shared/chunk-ZORK422C.js",
    ],
  },
  routes: {
    root: {
    ...
    "routes/healthcheck": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/healthcheck-POM7UMD5.js",
      imports: void 0,
      hasAction: !1,
      hasLoader: !0,
      hasCatchBoundary: !1,
    ...
    "routes/index": {
      ...
      index: !0,
      caseSensitive: void 0,
      module: "/build/routes/index-S4X36DCA.js",
      imports: ["/build/_shared/chunk-ACGOLZVQ.js"],
      hasAction: !1,
      hasLoader: !1,
      hasCatchBoundary: !1,
      hasErrorBoundary: !1,
    ...
    "routes/join": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/join-NS4WJJK2.js",
      imports: [
        "/build/_shared/chunk-VEATFOWL.js",
        "/build/_shared/chunk-ACGOLZVQ.js",
        "/build/_shared/chunk-TSFGPJJC.js",
      ],
      hasAction: !0,
      hasLoader: !0,
      hasCatchBoundary: !1,
    ...
    "routes/login": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/login-CZIGC47V.js",
      imports: [
        "/build/_shared/chunk-VEATFOWL.js",
        "/build/_shared/chunk-ACGOLZVQ.js",
        "/build/_shared/chunk-TSFGPJJC.js",
    ...
    "routes/logout": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/logout-6RWMV5JQ.js",
      imports: void 0,
      hasAction: !0,
      hasLoader: !0,
      hasCatchBoundary: !1,
    ...
    "routes/notes": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/notes-YNBCMUM6.js",
      imports: [
        "/build/_shared/chunk-ACGOLZVQ.js",
        "/build/_shared/chunk-P6GUL2BR.js",
        "/build/_shared/chunk-TSFGPJJC.js",
      ],
      hasAction: !1,
      hasLoader: !0,
    ...
    "routes/notes/$noteId": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/notes/$noteId-SE6SJV7Z.js",
      imports: void 0,
      hasAction: !0,
      hasLoader: !0,
      hasCatchBoundary: !0,
    ...
    "routes/notes/index": {
      ...
      index: !0,
      caseSensitive: void 0,
      module: "/build/routes/notes/index-H5MENEJG.js",
      imports: void 0,
      hasAction: !1,
      hasLoader: !1,
      hasCatchBoundary: !1,
    ...
    "routes/notes/new": {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: "/build/routes/notes/new-GSUFMYN5.js",
      imports: void 0,
      hasAction: !0,
      hasLoader: !1,
      hasCatchBoundary: !1,
  ...
  url: "/build/manifest-1540E7CF.js",
};
